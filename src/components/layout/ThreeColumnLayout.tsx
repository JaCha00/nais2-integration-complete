                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <Coins className={cn('h-4 w-4', isSlot2 ? 'text-purple-500' : 'text-amber-500')} />
                                                <span className={cn('text-sm font-semibold', isSlot2 ? 'text-purple-500' : 'text-amber-500')}>
                                ...
                                {isVerified2 && anlas2 && !slot2Enabled && (
                                    <Tip content={t('settingsPage.api.clickToResume2')}>
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border bg-muted/30 border-border/50 opacity-60 hover:opacity-90 transition-all"
                                        >
